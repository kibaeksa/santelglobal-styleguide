    ...
    <div class="code-wrap">
        ...
        <div class="code-box">
            <pre class="brush: html">
                // 기본 체크박스
                <div class="chk_box1">
                    <input type="checkbox" id="cart_prod_all">
    ...
    <div class="code-wrap">
        ...
        <div class="result_box">
            ...
            <div class="rdo_box1 blue">
				...
				<label for="order_mem" class="adipro-r" id="loginLabel">로그인</label>
			</div>
            
            <div class="rdo_box1 blue">
                <input type="radio" id="order_mem2" name="order_choice" value="Y" checked="">
                <label for="order_mem2" class="adipro-r" id="loginLabel">로그인</label>
            </div>
